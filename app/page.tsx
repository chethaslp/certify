    ...
    <main className="container mx-auto py-8 px-4 max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Link href="/send-email" className="block">
          <div className="border border-primary rounded-xl p-8 hover:shadow-lg transition-all h-full bg-primary/5 flex flex-col items-center text-center group">
            ...
            <h2 className="text-3xl font-bold mb-3">Send Certificates</h2>
            <p className="text-muted-foreground text-lg">Generate and send certificates with emails</p>
          </div>
        </Link>

        <Link href="/send-bulk-email" className="block">
          <div className="border border-primary rounded-xl p-8 hover:shadow-lg transition-all h-full bg-primary/5 flex flex-col items-center text-center group">
            <div className="h-24 w-24 bg-primary/10 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <Mail className="h-12 w-12 text-primary" />
            </div>
            <h2 className="text-3xl font-bold mb-3">Send Emails</h2>
            <p className="text-muted-foreground text-lg">Send bulk emails without certificates</p>
          </div>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/templates" className="block">
          <div className="border rounded-lg p-4 hover:border-primary hover:shadow-md transition-all h-full flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Manage your certificate designs</p>
            </div>
          </div>
        </Link>
        ...
        <Link href="/email-templates" className="block">
          <div className="border rounded-lg p-4 hover:border-primary hover:shadow-md transition-all h-full flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Manage your email content</p>
            </div>
          </div>
        </Link>
        ...
        <Link href="/settings" className="block">
          <div className="border rounded-lg p-4 hover:border-primary hover:shadow-md transition-all h-full flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Configure SMTP and profile</p>
            </div>
          </div>
        </Link>
      </div>
